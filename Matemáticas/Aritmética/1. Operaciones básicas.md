...
**División**: Representada por los signos $/$, $-$ y $\textdiv$. Esta operación consiste en formar grupos de elementos. Es la operación inversa de la multiplicación
...
- **Asociativa**: Se pueden hacer agrupaciones de números de distintas maneras: $3\cdot 4 + 4\cdot5 = 4\cdot (3+5)$
- **Distributiva:** Se puede distribuir las operaciones y el resultado se mantiene: $3 \cdot 10 = 3 \cdot 4 +3 \cdot 6$
