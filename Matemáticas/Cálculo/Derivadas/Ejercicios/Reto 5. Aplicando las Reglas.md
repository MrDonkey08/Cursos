...
$f\:'\:(x)$ $=-\cfrac{3\cdot \frac{2}{3\sqrt{x}}}{\:(3\sqrt{x})^2} -\left(-\cfrac{4}{x^2}\right)$$=-\cfrac{\frac{6}{2\sqrt{x}}}{9x} +\cfrac{4}{x^2}$$= -\cfrac{6}{18x\sqrt{x}} + \cfrac{4}{x^2}$ $= -\cfrac{1}{3\sqrt{x^3}} + \cfrac{4}{x^2}$
