...
La **programación orientada a objetos** es un _modelo de programación_ que utiliza _objetos_, ligados mediante _mensajes_, para la solución de problemas. La idea central es simple: organizar los programas a imagen y semejanza de la organización de los objetos en el mundo real.
...
- **Herencia:** Acción de crear una clase a partir de otra, heredando sus atributos y métodos. La clase que está heredando se le llama _clase base_, _súperclase_ o _clase padre_ y la clase que recibe la _herencia_ se le llama _clase derivada_, _subclase_ o _clase hija_.
...
- Ceballos, F. (). _Programación orientada a objetos con C++ (5<sup>a</sup>)_ 
