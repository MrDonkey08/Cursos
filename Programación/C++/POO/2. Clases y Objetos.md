...
class Persona {
	public:  // Public significa que pueden ser accedidos desde cualquier parte del programa.
		// Atributos
...
class Persona{
	private: // Privado significa a que solo puede ser accedidos por los métodos de la clase.
		string nombre = "Juan";
		int edad = 20;
