...
**Error de Ambiguedad:** Cuando se quiere utilizar la misma variable, tanto en el paso de parámetro como en la asignación, te encuentras con que el compilador no sabe si a cuál de los te refieres para resolver este problema se utiliza el puntero `this`. 
...
Coordenada &Coordenada::setXY(int x, int y){ // Modificador de 2 atributos: x & y
	this->x = x; 
	this->y = y;
	return *this;
}
